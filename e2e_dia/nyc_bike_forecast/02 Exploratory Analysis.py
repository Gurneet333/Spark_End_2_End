...
# MAGIC %md The rentals took off in 2017 but how much of this is tied to the expansion of the network?
...
# MAGIC     MAX(avg_temp_f) as max_temp_f
...
# MAGIC SELECT
# MAGIC   x.month,
# MAGIC   AVG(x.precip_mm) as avg_precip_mm
# MAGIC FROM (
# MAGIC   SELECT
# MAGIC     MONTH(time) as month,
# MAGIC     YEAR(time) as year,
# MAGIC     SUM(tot_precip_mm) as precip_mm
# MAGIC   FROM citibike.weather
# MAGIC   GROUP BY MONTH(time), YEAR(time)
# MAGIC   ) x
# MAGIC GROUP BY x.month
