...
# MAGIC 
# MAGIC val rawDataPath = "/mnt/dscc202-datasets/life_expectancy/"
# MAGIC 
...
# MAGIC %md
# MAGIC ### Health Indicators supplementary data
...
client.download_artifacts(latest_model_detail.run_id, "summary_plot.png", "/tmp")
...
# MAGIC %md
# MAGIC The United States stood out as an outlier in the life expectancy plot above. We might instead ask, how is the USA different relative to other countries. SHAP can help explain how features explain predicted life expectancy differently.  SHAP[!US] - SHAP[US]
...
# MAGIC %md
# MAGIC Mortality rate due to cardiac disease, diabetes and cancer stands out in the USA. On average, it explains almost a year less life expectancy than in other countries.
# MAGIC 
...
# MAGIC %md
# MAGIC 
# MAGIC ## 5. "What-If?" and Dashboarding
# MAGIC 
